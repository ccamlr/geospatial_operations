...
#Initial reference document: https://meetings.ccamlr.org/wg-asam-2023/01
#Input: table of vertices as provided in WG-ASAM-2023/01, Table 2.
...
#Import vertices
V=read.csv("Scripts/Krill_Fishery_Management_Units/ReUpdated_Vertices.csv")
...
#Inspection of the plots reveals problematic polygons for: DP and GS.
...
#Update labels locations (for plotting purposes)
P$Labx[P$ID=="PB"]=-2300000
P$Labx[P$ID=="EI"]=-2700000
P$Labx[P$ID=="DP"]=-2800000
P$Laby[P$ID=="DP"]=1200000
P$Labx[P$ID=="GS"]=-2600000
...
write.csv(Areas,"Scripts/Krill_Fishery_Management_Units/Management_Units_Areas.csv",row.names = F)

#Export Shapefile 
st_write(P, paste0("Scripts/Krill_Fishery_Management_Units/Candidate_Krill_MUs_V",V_MUS,".shp"),
         append = F,quiet = T)
