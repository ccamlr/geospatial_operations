...
files, and includes some external files (*e.g.*, coastlines and
bathymetry):
...
- External files: generated using external data and stored with their
  ...
  Their separate documentation is available
  [here](https://github.com/ccamlr/geospatial_operations/blob/main/Documentation/External_data.md).

All but the Combined files simply store spatial objects in a special
type of dataframe which has a column (named ‘*geometry*’ or ‘*geom*’)
that stores vertices in nested lists. Each row of this dataframe
corresponds to an individual object identified by its *ID*. Additional
columns of core metadata are included to facilitate plotting maps
(*e.g.*, the fields ‘*Labx*’ and ‘*Laby*’ help position labels in
projected space).

Taking the ASD file as an example, and after excluding the ‘geometry’
column, the file contains:
...
| ID | Class | Labx | Laby | Name | Class_long | Current | Version |
|:---|:---|---:|---:|:---|:---|:---|---:|
| 48 | ASD | -481544 | 3106412 | Antarctic Atlantic | Area | Yes | 1 |
| 48.1 | ASD | -2791629 | 1258857 | Peninsula | Subarea | Yes | 1 |
| 48.2 | ASD | -1983829 | 2577693 | South Orkney | Subarea | Yes | 1 |
| 48.3 | ASD | -2777967 | 2877737 | South Georgia | Subarea | Yes | 1 |
| 48.4 | ASD | -1635923 | 3508248 | South Sandwich | Subarea | Yes | 1 |
| 48.5 | ASD | -1389153 | 1646939 | Weddel Sea | Subarea | Yes | 1 |
| 48.6 | ASD | 284521 | 3269218 | Bouvet | Subarea | Yes | 1 |
| 58 | ASD | 2950867 | 2279846 | Antarctic Southern Indian | Area | Yes | 1 |
| 58.4.1 | ASD | 2736676 | -1593033 | Part of Enderby-Wilkes (58.4) | Division | Yes | 1 |
| 58.4.2 | ASD | 1708248 | 2129856 | Part of Enderby-Wilkes (58.4) | Division | Yes | 1 |
| 58.4.3a | ASD | 3132300 | 1356539 | Part of Enderby-Wilkes (58.4) | Division | Yes | 1 |
| 58.4.3b | ASD | 3262051 | 599471 | Part of Enderby-Wilkes (58.4) | Division | Yes | 1 |
| 58.4.4a | ASD | 2276988 | 3077172 | Part of Enderby-Wilkes (58.4) | Division | Yes | 1 |
| 58.4.4b | ASD | 2933662 | 2333549 | Part of Enderby-Wilkes (58.4) | Division | Yes | 1 |
| 58.5.1 | ASD | 4028777 | 1926476 | Part of Kerguelen, McDonald (58.5) | Division | Yes | 1 |
| 58.5.2 | ASD | 3977071 | 933296 | Part of Kerguelen, McDonald (58.5) | Division | Yes | 1 |
| 58.6 | ASD | 3643524 | 2844030 | Crozet | Subarea | Yes | 1 |
| 58.7 | ASD | 2577633 | 3835693 | Marion-Edward | Subarea | Yes | 1 |
| 88 | ASD | -807612 | -2238650 | Antarctic Pacific | Area | Yes | 1 |
| 88.1 | ASD | 132216 | -2677818 | Ross Sea | Subarea | Yes | 1 |
| 88.2 | ASD | -1402683 | -2033034 | Amundsen Sea | Subarea | Yes | 1 |
| 88.3 | ASD | -2633947 | 51371 | Bellingshausen Sea | Subarea | Yes | 1 |

The field ‘*Current*’ is used to track spatial objects that have been
created in the past, but may have been explicitly discarded. For
instance, all ‘Research Blocks’ are denoted as *Current*=Yes except for
883_5 and 883_7–883_10 which are denoted as *Current*=No following a
decision by the Scientific Committee
([SC-CAMLR-43](https://meetings.ccamlr.org/sc-camlr-43), paragraph 3.103
and 3.108).

The field ‘*Version*’ tracks the version of the geospatial dataset,
which changes if any geometry is modified, and the history of these
changes is documented
[here](https://github.com/ccamlr/geospatial_operations/blob/main/Documentation/Version_history.md).
...
The combined files (“CCAMLR_All.gpkg” and “CCAMLR_All_Clipped.gpkg”) are
different because they store per-Class files within layers, turning
these files into standalone geospatial databases. To see the content of
these files, one must use *sf::st_layers()*:
...
|:---|:---|:---|---:|---:|:---|
| Areas, Subareas and Divisions | Polygon | GPKG | 22 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Convention Area | Polygon | GPKG | 1 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| CEMP Sites | Point | GPKG | 37 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Exclusive Economic Zones | Polygon | GPKG | 4 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Krill Fishery Management Units | Polygon | GPKG | 9 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Management Areas | Polygon | GPKG | 8 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Marine Protected Areas | Polygon | GPKG | 6 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| MPA Planning Domains | Polygon | GPKG | 11 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Research Blocks | Multi Polygon | GPKG | 36 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Small Scale Management Units | Polygon | GPKG | 17 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Small Scale Research Units | Polygon | GPKG | 63 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Vulnerable Marine Ecosystems |  | GPKG | 158 | 8 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Coastline | Multi Polygon | GPKG | 6 | 5 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| GEBCO 2025 Polygons MidRes | Multi Polygon | GPKG | 24514 | 6 | WGS 84 / NSIDC EASE-Grid 2.0 South |
| Metadata | NA | GPKG | 175 | 5 |  |

<br>

<br>

Using such multi-layer file requires loading layers using their names
(which can be gathered from above) as follows:
