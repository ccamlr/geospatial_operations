...
- Inputs: Scripts and resulting *.csv* files of vertices locations, and
  additional metadata. These vertices are used to build “Master
  polygons” (polygons in their simplest form, not clipped to the
  coastline).
...
and relies on the use of a dataset of vertices (see
[Inputs](https://github.com/ccamlr/geospatial_operations/tree/main/Dataset/Inputs)
folder). All polygons have **primary vertices** (as described in their
FAO definitions, for example) and may have additional vertices that are
