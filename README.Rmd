...
library(knitr)
Evals=F          ##############Use FALSE to not update figures
```
...
- Step 2: Isolate polygons, inspect plots, and remove problematic polygon parts (see Fig. 4.1 as an example),

- Step 3: Update metadata (*e.g.*, coastline version) and export shapefiles (see [Candidate_Krill_MUs_V1.x] files).
