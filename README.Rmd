...
Let's plot these coordinates as they are, and connect them with lines, for each polygon:

```{r fig.align="center",out.width="80%",message=F,dpi=300,echo=T,eval=T,fig.cap="Figure 3.1. Polygon coordinates as they are given in the 'My_Polygons_Form.csv' file."}
#Read the file
