...
Below are descriptions of the process used to build the latest version of shapefiles (V2). In line with the Geospatial Rules and following the template provided in [WG-ASAM-2023/01], these areas can be updated using the [Krill_Fishery_Management_Units_Vx_x.R] script. This script follows these three steps:
