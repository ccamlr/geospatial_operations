...
library(knitr)
Evals=F          ##############Use FALSE to speed up specific updates
```
...
Plotting these coordinates as they are, and connecting them with lines for each polygon, gives:

```{r 'Fig3.1', fig.align="center",out.width="80%",message=F,dpi=300,echo=T,eval=T,fig.cap="Figure 3.1. Polygon coordinates as they are given in the 'My_Polygons_Form.csv' file."}
#Read the file
