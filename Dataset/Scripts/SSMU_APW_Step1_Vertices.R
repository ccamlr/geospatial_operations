...
sName="SSMU_APW_Step1_Vertices.R"
...
# Intersection between P83-P1 and I1-I2
tmp=get_C_intersection(Line1=c(PV$Longitude[PV$Vertex=="P83"],PV$Latitude[PV$Vertex=="P83"],
                               PV$Longitude[PV$Vertex=="P1"],PV$Latitude[PV$Vertex=="P1"]),
...
# Intersection between P2-P3 and I3-I4
...
MVtmp=bind_rows(
  ...
  IV[which(IV$Vertex=="I2"):which(IV$Vertex=="I3"),(1:3)],
  SV[which(SV$Vertex=="S92"),(1:3)],
  PV[which(PV$Vertex=="P2"):which(PV$Vertex=="P83"),(1:3)]
)
MVtmp$Name=pName
